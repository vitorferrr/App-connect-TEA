...
import ForgotPasswordPage from "./pages/ForgotPasswordPage"; // New forgot password page
import UpdatePasswordPage from "./pages/UpdatePasswordPage"; // New update password page
...
import EditProfilePage from "./pages/EditProfilePage"; // Importando a nova página de edição de perfil
      ...
      <BrowserRouter>
        <SessionProvider>
          <Routes>
            ...
            <Route path="/edit-profile" element={<EditProfilePage />} /> {/* Nova rota para edição de perfil */}
